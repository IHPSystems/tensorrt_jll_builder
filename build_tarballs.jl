...
unpack_deb(pkg) = "dpkg-deb -x /var/cache/apt/archives/$(pkg)_$(pkg_version)_*.deb $pkg"
cmds = """
apt-get update && \
...
dependencies = [
    Dependency(PackageSpec(; name="CUDNN_jll", version=VersionNumber(CUDNN_version.major)))
]
